...
void loop() {
  ...
  //for(int porcentaje=10;porcentaje>=0;porcentaje--){
      //ledcWrite(ledChanne2, 255-255*porcentaje/100);
      //ledcWrite(ledChanne3, 255*porcentaje/100);
      //delay(200);
    //}
  //for(int porcentaje=0;porcentaje<=10;porcentaje++){
      //ledcWrite(ledChanne2, 255-255*porcentaje/100);
      //ledcWrite(ledChanne3, 255*porcentaje/100);
      //delay(200);
    //}
