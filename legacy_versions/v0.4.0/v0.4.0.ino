...
const int brillo = 255;    // Define el brillo maximo del led RGB indicador de nivel (0 ~ 255)
...
double total = 13;              // Esta variable es el valor maximo de profundidad del tanque donde se va a utilizar el sensor de presion
...
void loop() {
  ...
  //  ledcWrite(ledChannel2, brillo*(1-porcentaje/100));
  //  ledcWrite(ledChannel3, brillo*porcentaje/100);
  //  delay(100);
