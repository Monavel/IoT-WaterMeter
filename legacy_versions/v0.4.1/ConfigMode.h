...
void getWiFiName(char* buff, size_t len, bool withPrefix = true) {
  ...
  String devName = String(BLYNK_TEMPLATE_NAME).substring(0, 31-7-devPrefix.length());
...
void enterConfigMode()
{
  ...
  lcd2.clear();
  lcd2.setCursor(0, 0);
  lcd2.print("Esperando");
  lcd2.setCursor(0,1);
  lcd2.print("configuracion");
...
void enterConnectNet() {
  ...
  lcd2.clear();
  lcd2.setCursor(0,0);
  lcd2.print("Conectandose a");
  lcd2.setCursor(0,1);
  lcd2.print(configStore.wifiSSID);
