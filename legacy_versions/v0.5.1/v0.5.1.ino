...
#define BLYNK_TEMPLATE_NAME "Medidor de profundidad"  

#define BLYNK_FIRMWARE_VERSION        "0.5.1"
...
double total = 1.2;              // Esta variable es el valor maximo de profundidad del tanque donde se va a utilizar el sensor de presion
...
LiquidCrystal_I2C lcd(0x3f, 16, 2);   //Declaracion del objeto para la pantalla. Las direcciones para la pantalla pueden ser 0x27 o 0x3f o 0x20 o 0x38 (depende del fabricante)
