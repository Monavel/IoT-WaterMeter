...
#define BLYNK_FIRMWARE_VERSION "0.6.5"
...
void myTimer() {
  ...
  // --- Redondeo ---
  Level_avg = round(Level_avg * 100.0) / 100.0;  // 2 decimales
  Vair_avg  = round(Vair_avg  * 1000.0) / 1000.0; // 3 decimales
  Vh2o_avg  = round(Vh2o_avg  * 1000.0) / 1000.0; // 3 decimales
 ...
 // Enviar porcentaje promedio redondeado
